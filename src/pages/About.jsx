...
export default function About() {
  ...
  const whatWeDoList = [
    t('about.what_we_do_list.0'),
    t('about.what_we_do_list.1'),
    t('about.what_we_do_list.2'),
    t('about.what_we_do_list.3'),
  ];

  const coreStrengths = [
    { 
      title: t('about.strengths.engineering.title'), 
      desc: t('about.strengths.engineering.desc'),
      icon: (
    ...
    { 
      title: t('about.strengths.quality.title'), 
      desc: t('about.strengths.quality.desc'),
      icon: (
        <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
    ...
    { 
      title: t('about.strengths.cost.title'), 
      desc: t('about.strengths.cost.desc'),
      icon: (
        <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
    ...
    { 
      title: t('about.strengths.support.title'), 
      desc: t('about.strengths.support.desc'),
      icon: (
        <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
  ...
  return (
    <section className="relative w-full my-9 overflow-hidden py-20 lg:py-2">
      <div className="relative z-10 mx-auto max-w-6xl px-8 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl">
          <div className="inline-flex items-center gap-2 rounded-full border border-cyan-500/30 bg-cyan-900/20 px-4 py-1.5 backdrop-blur-md mb-6">
            ...
            <span className="text-xs font-semibold tracking-widest text-cyan-300 uppercase">{t('about.badge')}</span>
          </div>
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-8 border-l-2 border-b-2 border-white/10 pl-6 lg:pl-10">
          <div className="lg:col-span-2 space-y-6 pt-5 text-xl text-slate-300 leading-relaxed">
            <p className='max-w-xl'>
              <strong className="text-white ">{t('about.intro_company_name')}</strong> {t('about.intro_1')}
            </p>
          ...
          <div className="relative ml-6 lg:-translate-y-16">
            <div className="relative w-56 h-72 sm:w-64 sm:h-80 lg:w-72 lg:h-96">
              ...
              <div className="absolute inset-0 m-20 animate-spin-slow">
                ...
                <div className="absolute bottom-0 right-1/2 translate-x-1/2 w-2 h-2 bg-blue-400 rounded-full shadow-lg shadow-blue-400/50"></div>
              </div>
              
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 transform -rotate-0 z-10 text-center">
                <div className="text-4xl font-semibold text-white" style={{ textShadow: '0 2px 20px rgba(0,0,0,0.5)' }}>H₂O</div>
                <div className="text-xs text-cyan-300 uppercase tracking-widest mt-1">{t('about.pure_water_drop')}</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="pr-4 border-r-2 border-b-2 border-white/10 grid gap-8 lg:grid-cols-2 items-stretch">
          ...
          <div className="group mt-10 lg:my-20 relative bg-gradient-to-br from-white/5 to-white/[0.02] border-white/10 p-8 lg:p-10 backdrop-blur-md overflow-hidden transition-all hover:border-cyan-500/30">
            ...
            <div className="relative z-10">
              <h3 className="text-2xl font-semibold text-white mb-2">{t('about.what_we_do_title')}</h3>
              <p className="text-slate-300 mb-8">{t('about.what_we_do_desc')}</p>
          ...
          <div className="flex mb-6 lg:my-20 flex-col gap-6">
            <div className="bg-slate-900/50 border-white/10 p-8 lg:p-10 backdrop-blur-md h-full">
              <h3 className="text-2xl font-semibold text-white mb-2">{t('about.core_strengths_title')}</h3>
        ...
        <div className="mt-20 relative rounded-3xl overflow-hidden border-l-2 border-white/10 bg-slate-800 shadow-2xl">
           ...
           <img src="../assets/images/roedi16m.jpeg" alt="Facility" className="w-full h-[40rem] object-cover hover:scale-105 transition-transform duration-1000" />
            <div className="absolute bottom-8 left-8 z-20">
              <div className="bg-slate-900/60 backdrop-blur-md border border-white/10 px-6 py-3 rounded-xl">
                 <p className="text-cyan-400 text-xs font-semibold uppercase tracking-widest mb-1">{t('about.img_badge')}</p>
                 <p className="text-white font-medium">{t('about.img_text')}</p>
              </div>
            </div>
        </div>
